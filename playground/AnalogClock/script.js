...
function startClock(){
    ...
    let secondsDegress = seconds * (360 / 60) + minutes * 360;
    let minuteDegrees = minutes * (360 / 60) + seconds / 12;
    let hourDegrees = hours * (360 / 12) + (minutes / 12) * (360 / 60);

    secHand.style.transform = `translateX(-50%) rotate(${secondsDegress}deg)`;
